...
all_cluster_files = glob.glob(directory_prefix+'cluster_*')
all_clusters_files = glob.glob(directory_prefix+'clusters*')
best_cluster_files = glob.glob(directory_prefix+best_cluster+'_*')
